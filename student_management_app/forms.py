...
from student_management_app.models import Classes, SectionOrBatch
...
class AddStudentForm(forms.Form):
    ...
    try:
        ...
        class_list = []
        for clss in classes:
            single_class = (clss.id, clss.class_name)
    ...
    try:
        ...
        for batch in batches:
            single_batch = (batch.id, batch.batch_name)
    ...
    batch_id = forms.ChoiceField(label="Batch", choices=batch_list, widget=forms.Select(attrs={"class":"form-control"}))
...
class EditStudentForm(forms.Form):
    ...
    try:
        ...
        batch_list = []
        for batch in batches:
            single_batch = (batch.id, str(batch.batch_name))
            batch_list.append(single_batch)
